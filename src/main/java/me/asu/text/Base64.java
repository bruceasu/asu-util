...
public class Base64 {
	 ...
	 *
	 * @param sArr The bytes to convert. If <code>null</code> or
	 * length 0 an empty array will be returned.
	 ...
	 * All illegal characters will be ignored and can handle both arrays
	 * with and without line separators.
	 *
	 * @param sArr The source array. <code>null</code> or
	 * length 0 will return an empty array.
	 ...
	 * representation i accordance withRFC 2045.
	 *
	 * @param sArr The bytes to convert. If <code>null</code> or
	 * length 0 an empty array will be returned.
	 * @param lineSep Optional "\r\n" after 76 characters, unless end of file.<br>
	...
	public final static String encodeToString(byte[] sArr, boolean lineSep) {
		// Reuse char[] since we can't get a String incrementally anyway and StringBuffer/Builder would be slower.
		return new String(encodeToChar(sArr, lineSep));
	}

	/**
	 * Decodes a BASE64 encoded <code>String</code>.
	 *
	 * All illegal characterswill be ignored and canhandle both strings
	 * with and without line separators.<br><b>Note!</b> It can be up to
	 * about 2x the speed to call<code>decode(str.toCharArray())</code>in
	 * stead. That will get a temporary array though.
	 ...
	 * <code>null</code> if thelegal characters(including '=') isn't divideable by 4.
	...
	/**
	 * Decodes a BASE64 encoded string that is known to be reasonably
	...
	public static class URLSafe {
		 ...
		 * <p>Note: 根据 RFC 4648 的规定，把『+』变成『-』，把『/』变成『_』，去除末尾填充的『=』
		 *
		 * @param url 需要编码的 URL
		...
		public static String encode(byte[] url, boolean lineSep) {
			return Base64.encodeToString(url, lineSep).replace('+', '-').replace('/', '_')
					.replaceAll("=", "");
		}
